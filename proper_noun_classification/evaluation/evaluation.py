...
x_test, y_test, seq_lens_test, vocab_dict     = data_utils.load_data_and_labels(test_filename, train=False)
...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        for batch in batches:
            ...
            batch_predictions, correct, batch_probs = sess.run([predictions, correct_vector, prediction_probs],             #batch_predictions = sess.run([predictions], \
